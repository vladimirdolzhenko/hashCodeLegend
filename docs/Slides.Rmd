...
* DDOS-атака с примененимем hashCode
...
нить-0: Драка по hashcode 0x30577220 после набега <span class="huge">520_271</span> чуваков

нить-1: Драка по hashcode 0x30695E88 после набега <span class="huge">436_503</span> чуваков

нить-2: Драка по hashcode 0x307F1988 после набега <span class="huge">157_580</span> чуваков

нить-3: Драка по hashcode 0x30A60DB8 после набега <span class="huge">150_222</span> чуваков

всего <span class="huge">1_264_576</span>

## Почему такие коллизии ?

нить-0: Драка по hashcode 0x30<span class="huge">57</span>7220 после набега 520_271 чуваков

нить-1: Драка по hashcode 0x30<span class="huge">69</span>5E88 после набега 436_503 чуваков

нить-2: Драка по hashcode 0x30<span class="huge">7F</span>1988 после набега 157_580 чуваков

нить-3: Драка по hashcode 0x30<span class="huge">A6</span>0DB8 после набега 150_222 чуваков
...
## Распределение адресов по нитям
...
разница между 1 и 0 : <span class="huge">1_432_032</span>

разница между 2 и 1 : <span class="huge">1_441_840</span>

разница между 3 и 2 : <span class="huge">1_431_408</span>
...
## Распределение адресов по нитям без TLAB
...
0x30213F<span class="huge">2</span>8

0x30213F<span class="huge">3</span>8

0x30213F<span class="huge">4</span>8

0x30213F<span class="huge">5</span>8

```
разница между 1 и 0 : 16
разница между 2 и 1 : 16
разница между 3 и 2 : 16
```
...
```
разница между 1 и 0 : 1,432,032
разница между 2 и 1 : 1,441,840
разница между 3 и 2 : 1,431,408
```
...
addressHashCode = read.csv(file = "csv/addressHashCode.csv", header = TRUE)
defaultHashCode = read.csv(file = "csv/defaultHashCode.csv", header = TRUE)
ggplot(alpha=0.75) +
