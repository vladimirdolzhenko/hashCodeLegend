...
<span class="huuuge highlight">сложность → **O(1)**</span>
...
<span class="huuuge highlight">сложность → **O(N)**</span>
...
```
```
<div style="text-align: center;"><span class="huuuge">**`username`**</span> ⟹ <span class="huuuge">499_331</span> вариантов коллизий</div>
...
## Бинарное дерево поиска {.rbTree}

![](images/hashtable-collisions-rbtree.svg)

<span class="huuuge highlight">сложность → **O( log(N) )**</span>
...
<div class="floating-box"><pre><code class="java pair">class Pair&lt;F, S&gt; {
  F first;
  S second;
}</code></pre></div>
<div class="floating-box"><pre><code class="java">class Pair2&lt;F, S&gt; {
...
<div class="floating-box"><pre><code class="java pair2">class Pair2&lt;F, S&gt; {
  F first;
  S second;
  int hashCode;
}</code></pre></div><div class="clear"></div>
