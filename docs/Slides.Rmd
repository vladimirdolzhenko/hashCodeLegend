...
## JOL : -XX:+UseCompressedOops и heap &lt; 4Gb {.jol2}
...
## JOL : -XX:-UseCompressedOops или heap &gt; 4Gb{.jol2}
...
## Распределение hashCode по нитям {.hashCodeDistribution}
...
## Границы коллизий :: многопоточный :: БЕЗ TLAB{.multiThreadedCollisions}
...
## Распределение hashCode по нитям БЕЗ TLAB {.hashCodeDistribution}
...
### спасибо: [\@VladimirSitnikv](https://twitter.com/VladimirSitnikv)  [\@dj_begemot](https://twitter.com/dj_begemot)  [\@AndreiPangin](https://twitter.com/AndreiPangin) [\@gvsmirnov](https://twitter.com/gvsmirnov) [\@shipilev](https://twitter.com/shipilev)  [\@i_sopov](https://twitter.com/i_sopov) 
