---
title: "Внутрь JVM сквозь замочную скважину hashCode"
...
<div class="center">![](images/shipilёv-unsafe_.jpg)</div>
...
## -XX:+UseCompressedOops и heap &lt; 32Gb {.jol0}
...
## -XX:+UseCompressedOops и heap &lt; 32Gb {.jol2}
...
## -XX:-UseCompressedOops или heap &ge; 32Gb{.jol0}
...
## -XX:-UseCompressedOops или heap &ge; 32Gb{.jol2}
...
ggplot(data=df, aes(x=reorder(alloc, -pos), y=value, fill=alloc)) +
  ...
  ggsave("allocations-st-sync.png")
```
...
<div class="thanks">спасибо: [\@VladimirSitnikv](https://twitter.com/VladimirSitnikv)  [\@dj_begemot](https://twitter.com/dj_begemot)  [\@AndreiPangin](https://twitter.com/AndreiPangin) [\@gvsmirnov](https://twitter.com/gvsmirnov) [\@i_sopov](https://twitter.com/i_sopov) [\@relgames](https://twitter.com/relgames)</div>
