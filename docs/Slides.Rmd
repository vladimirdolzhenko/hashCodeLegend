...
---------------|----------
  ...
  5 | <span class="highlight">[Marsagliа xor-shift ГПСЧ](https://en.wikipedia.org/wiki/Xorshift)</span> _**по умолчанию** в java 8_
...
@Benchmark
public String join1() {
    <span class="hl">buffer1.setLength(0);    return buffer1.append('a').toString()</span>;
}

@Benchmark
public String join2() {
    <span class="hl">buffer2.setLength(0);    return buffer2.append('a').toString()</span>;
}
...
@Benchmark
public String join2() {
    <span class="hl">buffer2</span>.setLength(0);    return <span class="hl">buffer2</span>.append('a').toString();
}

@Setup
public void setup(Blackhole bh) {
    buffer1 = new StringBuffer(); <span class="hl">buffer2 = new StringBuffer()</span>;
