---
title: 'Through the keyhole of #hashCode into JVM'
subtitle: "https://github.com/vladimirdolzhenko/hashCodeLegend"
author:
...
## Associative array / Dictionary / Map {.hash}
...
<span class="huuuge">complexity → <span class="highlight">**O( 1 )**</span></span>
...
<span class="huuuge">complexity → <span class="highlight">**O( N )**</span></span>

## Open Addressing

![](images/hashtable-collisions-oa_en.svg)

## Open Addressing {.openAddressing}

![](images/hashtable-collisions-oa2_en.svg)
...
<pre><code class="java">@BenchmarkMode(Mode.AverageTime)
<span class="hl">@Warmup(iterations = 5, time = 5, timeUnit = SECONDS)</span>
...
<pre><code class="java"><span class="hl">@BenchmarkMode(Mode.AverageTime)</span>
@Warmup(iterations = 5, time = 5, timeUnit = SECONDS)
<span class="hl">@Measurement(iterations = 5, time = 5, timeUnit = SECONDS)</span>
@State(Scope.Benchmark)
public class MapPerfTest {
...
# extra <span class="orthogonal">function</span> is required

## Extra function: compareTo {.rbTree}

![](images/hashtable-collisions-rbtree.svg)

<span class="huuuge">complexity → <span class="highlight">**O( log( N ) )**</span></span>

## Chaining &amp; Red-Black-Tree {.chainingRBTree}
...
df78 <- subset(df, java == "java 8" | java == 'java 7' | java == "base")
...
ggplot(data=d, aes(x=size, y=time_msec, group=java, colour=java)) +
  geom_line(linetype="solid", size=2) +
  geom_point(aes(shape=java),size=6) +
  scale_color_manual(values=c("java 8"="#1fbec3", "java 7"="#f57670", "base"="#BBBBBB")) +
  scale_shape_manual(values=c("java 8"=17, "java 7"=19, "base"=18))+
  scale_y_continuous(labels = function(n){format(n, big.mark = "_", scientific = FALSE)}) +
  scale_x_continuous(labels = function(n){format(n, big.mark = "_", scientific = FALSE)}) +
...
## -XX:+UseCompressedOops &amp; heap &lt; 32Gb {.jol0}
...
## -XX:+UseCompressedOops &amp; heap &lt; 32Gb {.jol2}
...
## -XX:-UseCompressedOops OR heap &ge; 32Gb{.jol0}
...
## -XX:-UseCompressedOops OR heap &ge; 32Gb{.jol2}
...
<div class="hblock"> OFFSET  SIZE   TYPE DESCRIPTION
      0    16        (object header)
     16     4    int <span class="highlight huuge">Pair2.hashCode</span>
...
## Weak generational hypothesis {.generations}

![](images/generations.svg)

**Generational GCs**: Serial, Parallel, CMS and _even_ G1
...
## How many could fit in heap ? {.heap}
...
Оbject reallocated: 0x12A8109F0 -> 0x12E7200F8
</code></pre>
...
ggplot(data=df, mapping = aes(x = address, y = index, group=thread, colour=thread, shape=thread)) +
  ...
  labs(
    ...
    x = "addresses of objects",
    y = "") +
  geom_vline(xintercept = 809203744, linetype = "dashed") +
  geom_hline(yintercept = 890552, linetype = "dashed") +
  scale_shape_manual(values=c("thread-0"=17, "thread-1"=19, "thread-2"=15, "thread-3"=9))+
...
# What if it is a <span class="huuge">Random</span> ?
...
---------------|----------
  ...
  5 | <span class="good">[Marsaglia xor-shift RNG](https://en.wikipedia.org/wiki/Xorshift)</span> _**by default** in java 8_
...
<div class="thanks">thanks: [\@VladimirSitnikv](https://twitter.com/VladimirSitnikv)  [\@dj_begemot](https://twitter.com/dj_begemot)  [\@AndreiPangin](https://twitter.com/AndreiPangin) [\@gvsmirnov](https://twitter.com/gvsmirnov) [\@i_sopov](https://twitter.com/i_sopov)</div>
