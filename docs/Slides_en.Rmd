...
<embed src="images/hashtable-put3_en.svg" type="image/svg+xml" />
...
<embed src="images/hashtable-broken_en.svg" type="image/svg+xml" />

## Collisions

<embed src="images/hashtable-collisions_en.svg" type="image/svg+xml" />

## Chaining

<embed src="images/hashtable-collisions-chaining_en.svg" type="image/svg+xml" />
...
* <span class="huge">1997-04-17 (!!!)</span>: [java bug #4045622](http://bugs.java.com/bugdatabase/view_bug.do?bug_id=4045622)
    ...
    + All of the strings in `/bin/*`, `/usr/bin/*`, `/usr/lib/*`, `/usr/ucb/*` и `/usr/openwin/bin/*`  (66_304 strings, avg length: 21 chars).
...
public class MapPerfTest {
  ...
  public void fillMap( Blackhole bh ) {
    <span class="hl">for (String key : keys) map.put(key, key);
    bh.consume( map );</span>
  }

  Map map = new HashMap(); String[] keys; 
  
  @Setup
  public void setup() {
    keys = loadUsernameCollisionsFromFile();
  }
}
</code></pre>
...
<embed src="images/hashtable-collisions-rbtree_en.svg" type="image/svg+xml" />
...
<embed src="images/reallocation2_en.svg" type="image/svg+xml" />
...
<embed src="images/obj-count_en.svg" type="image/svg+xml" />
...
```
<embed src="images/less-is-more_en.svg" type="image/svg+xml" />
